...
setwd("C:\\MOOC\\Insofe\\Data Visualization\\20170723_Batch29_CSE7120c_GgplotVisualization_Lab01")
...
hist(city_mpg, col="brown", xlab="City Mileage",
     qmain="Frequency Histogram:City Mileage",xlim = c(5,50), ylim = c(0,70))
