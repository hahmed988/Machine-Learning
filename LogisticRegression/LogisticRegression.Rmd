...
setwd("C:\\MOOC\\Insofe\\Module 1 - Probability and Statistics\\Logistic Regression\\20170701_Batch29_CSE7302c_LogisticRegression_Activity")
...
model_aicb <- stepAIC(log_reg, direction = "backward")
model_aicf <- stepAIC(log_reg, direction = "forward")
vif(model_aic)
vif(log_reg)
